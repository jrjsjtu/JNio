...
public interface ChannelOutboundInvoker {
     ...
     * called of the next {ChannelOutboundHandler} contained in the {@link ChannelPipeline} of the
     * {@link Channel}.
     */
     ...
     * a {ConnectTimeoutException}. If it fails because of connection refused a {@link ConnectException}
     * will be used.
     * <p>
     * This will result in having the
     * {ChannelOutboundHandler#connect(ChannelHandlerContext, SocketAddress, SocketAddress, ChannelPromise)}
     * method called of the next {ChannelOutboundHandler} contained in the {@link ChannelPipeline} of the
     * {@link Channel}.
     */
     ...
     * read, and triggers a
     * { ChannelInboundHandler#channelReadComplete(ChannelHandlerContext) channelReadComplete} event so the
    ...
    /**
     * Request to write a message via this { ChannelHandlerContext} through the {@link ChannelPipeline}.
